...
class IGrapheTest {
    ...
    void exo3_1Maths() {
        ...
        representation.GrapheLArcs glarcs = new representation.GrapheLArcs(g31a);
        tester3_1(glarcs);
    }

    void tester3_1(graphe.IGraphe g) {
    ...
    void importer() throws NumberFormatException, FileNotFoundException {
        ...
        graphe.IGraphe g = new GrapheLAdj();
        SAE.Arc.Arc a = graphe.GraphImporter.importer("graphes/ac/g-10-1.txt", g);
