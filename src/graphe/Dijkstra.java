...
public class Dijkstra{
    ...
    private static void initDijkstra(IGraphe g, String source, Map<String, Integer> dist, Map<String, String> prev) {
    ...
    public static void dijkstra(IGraphe g, String source, Map<String, Integer> dist, Map<String, String> prev) {
        ...
        List <String> sAVisiter = new ArrayList<String>(g.getSommets());
